...
fun timeForHalfWay(t1: Double, v1: Double,
    ...
    else { if ((t1*v1 < s) && (t1*v1+t2*v2 >= s)) return t1+((s-t1*v1)/v2)
...
fun whichRookThreatens(kingX: Int, kingY: Int,
    ...
    if ((kingX != rookX1) && (kingX != rookX2) && (kingY != rookY1) && (kingY != rookY1)) return 0
...
fun rookOrBishopThreatens(kingX: Int, kingY: Int,
    ...
    if ((kingX != rookX)&&(kingY != rookY)&&(Xkb !=Ykb)) return 0
    else { if (((kingX == rookX)||(kingY == rookY))&&((Xkb != Ykb))) return 1
        else { if (((Xkb == Ykb))&&((kingX !=rookX)&&(kingY !=rookY))) return 2
            else return 3}}
}
