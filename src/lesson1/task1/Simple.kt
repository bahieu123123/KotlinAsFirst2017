...
fun angleInRadian(grad: Int, min: Int, sec: Int): Double {
   return ((grad + min/60.0 + sec/3600.0)/180)*PI
}
 ...
 */
fun thirdDigit(number: Int): Int = floorDiv( number % 1000, 100)
/**
 * Простая
 *
 ...
 */
fun numberRevert(number: Int): Int = (number % 10) * 100 + (number % 100 - number % 10) + floorDiv( number, 100)
